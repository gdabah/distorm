...
"\x05" "MOVSX\0" "\x04" "XADD\0" "\x06" "MOVNTI\0" "\x05" "BSWAP\0" "\x04" "SLDT\0" \
"\x03" "STR\0" "\x04" "LLDT\0" "\x03" "LTR\0" "\x04" "VERR\0" "\x04" "VERW\0" \
"\x04" "SGDT\0" "\x04" "SIDT\0" "\x04" "LGDT\0" "\x04" "LIDT\0" "\x04" "SMSW\0" \
"\x04" "LMSW\0" "\x06" "INVLPG\0" "\x06" "VMCALL\0" "\x08" "VMLAUNCH\0" "\x08" "VMRESUME\0" \
"\x06" "VMXOFF\0" "\x07" "MONITOR\0" "\x05" "MWAIT\0" "\x06" "XGETBV\0" "\x06" "XSETBV\0" \
...
"\x05" "MOVSS\0" "\x05" "MOVSD\0" "\x06" "VMOVSS\0" "\x06" "VMOVSD\0" "\x07" "VMOVUPS\0" \
"\x07" "VMOVUPD\0" "\x07" "MOVHLPS\0" "\x06" "MOVLPS\0" "\x06" "MOVLPD\0" "\x08" "MOVSLDUP\0" \
...
"\x07" "VCOMISS\0" "\x07" "VCOMISD\0" "\x06" "PSHUFB\0" "\x07" "VPSHUFB\0" \
"\x06" "PHADDW\0" "\x07" "VPHADDW\0" "\x06" "PHADDD\0" "\x07" "VPHADDD\0" "\x07" "PHADDSW\0" \
...
"\x06" "PEXTRB\0" "\x07" "VPEXTRB\0" "\x06" "PEXTRW\0" "\x07" "VPEXTRW\0" "\x06" "PEXTRD\0" \
"\x06" "PEXTRQ\0" "\x07" "VPEXTRD\0" "\x09" "EXTRACTPS\0" "\x0a" "VEXTRACTPS\0" \
"\x0b" "VINSERTF128\0" "\x0c" "VEXTRACTF128\0" "\x06" "PINSRB\0" "\x07" "VPINSRB\0" \
"\x08" "INSERTPS\0" "\x09" "VINSERTPS\0" "\x06" "PINSRD\0" "\x06" "PINSRQ\0" \
"\x07" "VPINSRD\0" "\x07" "VPINSRQ\0" "\x04" "DPPS\0" "\x05" "VDPPS\0" "\x04" "DPPD\0" \
"\x05" "VDPPD\0" "\x07" "MPSADBW\0" "\x08" "VMPSADBW\0" "\x09" "PCLMULQDQ\0" \
"\x0a" "VPCLMULQDQ\0" "\x09" "VBLENDVPS\0" "\x09" "VBLENDVPD\0" "\x09" "VPBLENDVB\0" \
"\x09" "PCMPESTRM\0" "\x0a" "VPCMPESTRM\0" "\x09" "PCMPESTRI\0" "\x09" "VCMPESTRI\0" \
"\x09" "PCMPISTRM\0" "\x0a" "VPCMPISTRM\0" "\x09" "PCMPISTRI\0" "\x0a" "VPCMPISTRI\0" \
"\x0f" "AESKEYGENASSIST\0" "\x10" "VAESKEYGENASSIST\0" "\x08" "MOVMSKPS\0" \
"\x08" "MOVMSKPD\0" "\x09" "VMOVMSKPS\0" "\x09" "VMOVMSKPD\0" "\x06" "SQRTPS\0" \
"\x06" "SQRTPD\0" "\x06" "SQRTSS\0" "\x06" "SQRTSD\0" "\x07" "VSQRTSS\0" "\x07" "VSQRTSD\0" \
"\x07" "VSQRTPS\0" "\x07" "VSQRTPD\0" "\x07" "RSQRTPS\0" "\x07" "RSQRTSS\0" \
"\x08" "VRSQRTSS\0" "\x08" "VRSQRTPS\0" "\x05" "RCPPS\0" "\x05" "RCPSS\0" "\x06" "VRCPSS\0" \
"\x06" "VRCPPS\0" "\x05" "ANDPS\0" "\x05" "ANDPD\0" "\x06" "VANDPS\0" "\x06" "VANDPD\0" \
...
"\x07" "VPSHUFD\0" "\x08" "VPSHUFHW\0" "\x08" "VPSHUFLW\0" "\x05" "PSRLW\0" \
"\x06" "VPSRLW\0" "\x05" "PSRAW\0" "\x06" "VPSRAW\0" "\x05" "PSLLW\0" "\x06" "VPSLLW\0" \
"\x05" "PSRLD\0" "\x06" "VPSRLD\0" "\x05" "PSRAD\0" "\x06" "VPSRAD\0" "\x05" "PSLLD\0" \
"\x06" "VPSLLD\0" "\x05" "PSRLQ\0" "\x06" "VPSRLQ\0" "\x06" "PSRLDQ\0" "\x07" "VPSRLDQ\0" \
"\x05" "PSLLQ\0" "\x06" "VPSLLQ\0" "\x06" "PSLLDQ\0" "\x07" "VPSLLDQ\0" "\x07" "PCMPEQB\0" \
...
"\x07" "CLFLUSH\0" "\x07" "LDMXCSR\0" "\x08" "VLDMXCSR\0" "\x07" "STMXCSR\0" \
"\x08" "VSTMXCSR\0" "\x06" "POPCNT\0" "\x03" "BSR\0" "\x05" "LZCNT\0" "\x07" "CMPEQPS\0" \
...
"\x07" "VPINSRW\0" "\x06" "SHUFPS\0" "\x06" "SHUFPD\0" "\x07" "VSHUFPS\0" "\x07" "VSHUFPD\0" \
"\x09" "CMPXCHG8B\0" "\x0a" "CMPXCHG16B\0" "\x07" "VMPTRST\0" "\x07" "VMPTRLD\0" \
"\x07" "VMCLEAR\0" "\x05" "VMXON\0" "\x08" "ADDSUBPD\0" "\x08" "ADDSUBPS\0" \
"\x09" "VADDSUBPD\0" "\x09" "VADDSUBPS\0" "\x05" "PADDQ\0" "\x06" "VPADDQ\0" \
...
"\x06" "VPAVGB\0" "\x05" "PAVGW\0" "\x06" "VPAVGW\0" "\x07" "PMULHUW\0" "\x08" "VPMULHUW\0" \
...
"\x05" "LDDQU\0" "\x06" "VLDDQU\0" "\x07" "PMULUDQ\0" "\x08" "VPMULUDQ\0" "\x07" "PMADDWD\0" \
...
"\x05" "PADDD\0" "\x06" "VPADDD\0" "\x03" "ROL\0" "\x03" "ROR\0" "\x03" "RCL\0" \
"\x03" "RCR\0" "\x03" "SHL\0" "\x03" "SHR\0" "\x03" "SAL\0" "\x03" "SAR\0" \
"\x04" "FADD\0" "\x04" "FMUL\0" "\x04" "FCOM\0" "\x05" "FCOMP\0" "\x04" "FSUB\0" \
"\x05" "FSUBR\0" "\x04" "FDIV\0" "\x05" "FDIVR\0" "\x03" "FLD\0" "\x03" "FST\0" \
"\x04" "FSTP\0" "\x06" "FLDENV\0" "\x05" "FLDCW\0" "\x04" "FXCH\0" "\x04" "FNOP\0" \
"\x04" "FCHS\0" "\x04" "FABS\0" "\x04" "FTST\0" "\x04" "FXAM\0" "\x04" "FLD1\0" \
"\x06" "FLDL2T\0" "\x06" "FLDL2E\0" "\x05" "FLDPI\0" "\x06" "FLDLG2\0" "\x06" "FLDLN2\0" \
"\x04" "FLDZ\0" "\x05" "F2XM1\0" "\x05" "FYL2X\0" "\x05" "FPTAN\0" "\x06" "FPATAN\0" \
"\x07" "FXTRACT\0" "\x06" "FPREM1\0" "\x07" "FDECSTP\0" "\x07" "FINCSTP\0" \
"\x05" "FPREM\0" "\x07" "FYL2XP1\0" "\x05" "FSQRT\0" "\x07" "FSINCOS\0" "\x07" "FRNDINT\0" \
"\x06" "FSCALE\0" "\x04" "FSIN\0" "\x04" "FCOS\0" "\x07" "FNSTENV\0" "\x06" "FSTENV\0" \
"\x06" "FNSTCW\0" "\x05" "FSTCW\0" "\x05" "FIADD\0" "\x05" "FIMUL\0" "\x05" "FICOM\0" \
"\x06" "FICOMP\0" "\x05" "FISUB\0" "\x06" "FISUBR\0" "\x05" "FIDIV\0" "\x06" "FIDIVR\0" \
"\x06" "FCMOVB\0" "\x06" "FCMOVE\0" "\x07" "FCMOVBE\0" "\x06" "FCMOVU\0" "\x07" "FUCOMPP\0" \
"\x04" "FILD\0" "\x06" "FISTTP\0" "\x04" "FIST\0" "\x05" "FISTP\0" "\x07" "FCMOVNB\0" \
"\x07" "FCMOVNE\0" "\x08" "FCMOVNBE\0" "\x07" "FCMOVNU\0" "\x04" "FENI\0" "\x06" "FEDISI\0" \
"\x06" "FSETPM\0" "\x06" "FUCOMI\0" "\x05" "FCOMI\0" "\x06" "FNCLEX\0" "\x05" "FCLEX\0" \
"\x06" "FNINIT\0" "\x05" "FINIT\0" "\x06" "FRSTOR\0" "\x05" "FFREE\0" "\x05" "FUCOM\0" \
"\x06" "FUCOMP\0" "\x06" "FNSAVE\0" "\x05" "FSAVE\0" "\x06" "FNSTSW\0" "\x05" "FSTSW\0" \
...
"\x04" "IDIV\0" "\x04" "WAIT\0" "\x06" "MOVSXD\0" "\x05" "PAUSE\0";
