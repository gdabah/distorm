...
public enum OpcodeEnum {
	...
	JA, JB, CWDE, VCMPLEPD, VMWRITE, VCMPLEPS, PMOVMSKB, INSERTPS, _3DNOW, PCMPESTRI,
	WAIT, VCMPFALSE_OSPD, PCMPESTRM, PUNPCKLDQ, MULSS, VSUBPD, CMPEQPD, VCMPNEQ_OQSD,
	VCOMISD, VMINSS, VPADDD, RDMSR, VPSIGNW, JECXZ, MULSD, ENTER, MOVBE, VZEROALL,
	VMINSD, VCMPNEQ_OQSS, PFSUBR, VCMPGEPS, VPSUBUSB, VFMSUB231SD, PMAXUD, FXSAVE,
	FISTTP, VCMPGEPD, BLENDPS, VCMPLESD, FCMOVNBE, VFMSUB231SS, VBLENDVPS, VMPSADBW,
	VPSUBUSW, VCMPLTSD, MOVNTDQA, SHUFPD, SUBPD, SQRTPD, VMOVHPD, VMCALL, VFMADD132PD,
	LEAVE, SHUFPS, VCMPEQ_OSPS, VPCMPESTRI, VCMPLTSS, VPCMPESTRM, VFMADD132PS,
	LIDT, F2XM1, VMOVHPS, PMOVZXDQ, VZEROUPPER, SQRTPS, VANDNPS, VPADDQ, FPREM,
	VPADDW, PALIGNR, PMINSB, PCMPGTW, SHLD, LDS, VPADDB, VMRUN, RDFSBASE, VANDNPD,
	XLAT, XCHG, FINCSTP, MOVDQ2Q, PMINSW, SMSW, VPSIGNB, XRSTOR, VBLENDPD, JGE,
	VCMPNLT_UQPS, VCMPORDSD, VBLENDPS, FTST, CVTTPD2DQ, VCMPORDSS, VCMPNLT_UQPD,
