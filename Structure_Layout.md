...
For more information look at [DecomposeInterface](DecomposeInterface.md).
...
```
  ...
  * The above enum list is subject to change in each compilation of disOps, since it's auto-generated. Just include the "mnemonics.h" header file.